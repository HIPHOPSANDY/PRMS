...
$patage=$_POST['patage'];
$medhis=$_POST['medhis'];
$doctersession=$_POST['doctersession'];
$sql=mysqli_query($con,"update tblpatient set PatientName='$patname',PatientContno='$patcontact',PatientEmail='$patemail',PatientGender='$gender',PatientAdd='$pataddress',PatientAge='$patage',PatientMedhis='$medhis', PatientAge='$PatientAge',doctersession='$doctersession' where ID='$eid'");
if($sql)
{
...
<textarea type="text" name="doctersession" class="form-control"  placeholder="Docter Session" required="true"><?php  echo $row['doctersession'];?></textarea>
</div>
