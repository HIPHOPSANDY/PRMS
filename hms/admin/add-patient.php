...
if (isset($_POST['submit'])) {
	...
	$sql = mysqli_query($con, "insert into tblpatient(Docid,PatientName,PatientContno,PatientEmail,PatientGender,PatientAdd,PatientAge,PatientMedhis,doctersession)
 values('$docid','$patname','$patcontact','$patemail','$gender','$pataddress','$patage','$medhis','$doctersession')");
	if ($sql) {
											...
											<div class="panel-body">
												<form role="form" name="" method="post">
													...
													<div class="form-group">
														...
														<textarea type="text" name="doctersession" class="form-control" placeholder="Doctor Session" required="true"></textarea>
													</div>
